    ...
    <div id="wd-working-with-arrays">
        ...
        <div className="form-control-sm">
            <div className="form-check form-check-inline">
                <input id="wd-update-todo-completed" defaultChecked={todo.completed} type="checkbox" className="form-check-input"
                        onChange={(e) => setTodo({ ...todo, completed: e.target.checked }) }/>
                <label className="form-check-label" htmlFor="wd-update-todo-completed">Completed</label>
            </div>
        </div>                
        <br /><br /><hr />
    </div>
